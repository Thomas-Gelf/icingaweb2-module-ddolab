...
GRANT ALL ON icinga2.* TO icinga2@'%' IDENTIFIED BY 'icinga2';

CREATE DATABASE icingaweb2;
GRANT ALL ON icingaweb2.* TO icingaweb2@'%' IDENTIFIED BY 'icingaweb2';

CREATE DATABASE director;
GRANT ALL ON director.* TO director@'%' IDENTIFIED BY 'director';

CREATE DATABASE ddolab;
GRANT ALL ON ddolab.* TO ddolab@'%' IDENTIFIED BY 'ddolab';

FLUSH PRIVILEGES;
EOF

mysql icingaweb2 <<'EOF'
-- MySQL dump 10.15  Distrib 10.0.29-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: mysql1.lxc    Database: mysql1.lxc
-- ------------------------------------------------------
...
-- Dump completed on 2017-02-07  6:28:14
EOF
...
mysql icingaweb2 -e 'INSERT INTO icingaweb_user (name, active, password_hash) VALUES ("icingaadmin", 1, "$1$JMdnEc9M$FW7yapAjv0atS43NkapGo/");'
